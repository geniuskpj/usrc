...
{
/*
	pSharedMemStruct->absoluteEncoderContent.position = 0;
	pSharedMemStruct->absoluteEncoderContent.angle = 0;

	pSharedMemStruct->imu_Content.Fx = 0.0;
	pSharedMemStruct->imu_Content.Fy = 0.0;
	pSharedMemStruct->imu_Content.Fz = 0.0;
	pSharedMemStruct->imu_Content.Tx = 0.0;
	pSharedMemStruct->imu_Content.Ty = 0.0;
	pSharedMemStruct->imu_Content.Tz = 0.0;
*/
	return InitSharedMemModule(0);
